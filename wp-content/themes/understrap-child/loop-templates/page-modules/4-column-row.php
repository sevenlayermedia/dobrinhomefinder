...
<div class="wrapper wrapper-content<?php if($wrapper_class): echo ' ' . $wrapper_class; endif; ?>" <?php if($wrapper_background_color || $wrapper_background_image): ?>style="<?php if($wrapper_background_color): echo 'background-color: ' . $wrapper_background_color; endif; ?><?php if($wrapper_background_color && $wrapper_background_image): echo '; '; endif; ?><?php if($wrapper_background_image): echo 'background-image: url(' . $wrapper_background_image['url'] . ')'; endif ?>"<?php endif; ?>>
	<div class="<?php if(($container_fluid) == true): echo 'container-fluid'; else: echo 'container'; endif; ?><?php if($container_class): echo ' ' . $container_class; endif; ?>" <?php if($container_background_color || $container_background_image): ?>style="<?php if($container_background_color): echo 'background-color: ' . $container_background_color; endif; ?><?php if($container_background_color && $container_background_image): echo '; '; endif; ?><?php if($container_background_image): echo 'background-image: url(' . $container_background_image['url'] . ')'; endif ?>"<?php endif; ?>>
		<div class="row<?php if($row_class): echo ' ' . $row_class; endif; ?>" <?php if($row_background_color || $row_background_image): ?>style="<?php if($row_background_color): echo 'background-color: ' . $row_background_color; endif; ?><?php if($row_background_color && $row_background_image): echo '; '; endif; ?><?php if($row_background_image): echo 'background-image: url(' . $row_background_image['url'] . ')'; endif ?>"<?php endif; ?>>
			<div class="col-12 col-md-6 col-lg-3 py-2 py-lg-0<?php if($col_1_class): echo ' ' . $col_1_class; endif; ?><?php if($col_1_background_image): echo ' bg-cover'; endif; ?>" <?php if($col_1_background_color || $col_1_background_image): ?>style="<?php if($col_1_background_color): echo 'background-color: ' . $col_1_background_color; endif; ?><?php if($col_1_background_color && $col_1_background_image): echo '; '; endif; ?><?php if($col_1_background_image): echo 'background-image: url(' . $col_1_background_image['url'] . ')'; endif ?>"<?php endif; ?>>
			...
			<div class="col-12 col-md-6 col-lg-3 py-2 py-lg-0<?php if($col_3_class): echo ' ' . $col_3_class; endif; ?><?php if($col_3_background_image): echo ' bg-cover'; endif; ?>" <?php if($col_3_background_color||$col_3_background_image): ?>style="<?php if($col_3_background_color): echo 'background-color: ' . $col_3_background_color; endif; ?><?php if($col_3_background_color && $col_3_background_image): echo '; '; endif; ?><?php if($col_3_background_image): echo 'background-image: url(' . $col_3_background_image['url'] . ')'; endif ?>"<?php endif; ?>>
				<?php if($col_3_link): ?><a href="<?php echo $col_3_link['url'] ?>" class="col-btn <?php if (strpos($col_3_class, 'justify-content-center') !== false): echo 'w-100 h-100 d-table'; endif; ?>" role="button"><?php endif; ?>
					<?php if(empty($col_3_link) && ($col_3_background_color || $col_3_background_image)): ?><div class="w-100 h-100 d-table"><?php endif; ?>
						<div class="position-relative<?php if(strpos($col_3_class, 'justify-content-center') !== false): echo ' d-table-cell align-middle'; else: echo ' '; endif; ?>">
							<?php
							// the loop
							// check if the flexible content field has rows of data
							if(have_rows('col_3_content')):
								// loop through the rows of data
								while(have_rows('col_3_content')):the_row();
									if( get_row_layout() == 'heading' ):
										get_template_part( 'loop-templates/page-modules/content-blocks/heading', 'block' );
									elseif( get_row_layout() == 'text_area' ):
										get_template_part( 'loop-templates/page-modules/content-blocks/text-area', 'block' );
					...
					<?php if(empty($col_3_link) && ($col_3_background_color || $col_3_background_image)): echo '</div><!-- .d-table -->'; endif; ?>
				<?php if($col_3_link): echo '</a>'; endif; ?>
			</div><!-- .col -->
			<div class="col-12 col-md-6 col-lg-3 py-2 py-lg-0<?php if($col_4_class): echo ' ' . $col_4_class; endif; ?><?php if($col_4_background_image): echo ' bg-cover'; endif; ?>" <?php if($col_4_background_color||$col_4_background_image): ?>style="<?php if($col_4_background_color): echo 'background-color: ' . $col_4_background_color; endif; ?><?php if($col_4_background_color && $col_4_background_image): echo '; '; endif; ?><?php if($col_4_background_image): echo 'background-image: url(' . $col_4_background_image['url'] . ')'; endif ?>"<?php endif; ?>>
				<?php if($col_4_link): ?><a href="<?php echo $col_4_link['url'] ?>" class="col-btn <?php if (strpos($col_4_class, 'justify-content-center') !== false): echo 'w-100 h-100 d-table'; endif; ?>" role="button"><?php endif; ?>
					<?php if(empty($col_4_link) && ($col_4_background_color || $col_4_background_image)): ?><div class="w-100 h-100 d-table"><?php endif; ?>
						<div class="position-relative<?php if(strpos($col_4_class, 'justify-content-center') !== false): echo ' d-table-cell align-middle'; else: echo ' '; endif; ?>">
							<?php
							// the loop
							// check if the flexible content field has rows of data
							if(have_rows('col_4_content')):
								// loop through the rows of data
								while(have_rows('col_4_content')):the_row();
									if( get_row_layout() == 'heading' ):
										get_template_part( 'loop-templates/page-modules/content-blocks/heading', 'block' );
									elseif( get_row_layout() == 'text_area' ):
										get_template_part( 'loop-templates/page-modules/content-blocks/text-area', 'block' );
					...
					<?php if(empty($col_4_link) && ($col_4_background_color || $col_4_background_image)): echo '</div><!-- .d-table -->'; endif; ?>
				<?php if($col_4_link): echo '</a>'; endif; ?>
			</div><!-- .col -->
		</div><!-- .row -->
	</div><!-- .container -->
</div><!-- .wrapper -->